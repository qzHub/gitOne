...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		...
		default:
            ...
            [button setTitleColor:[UIColor colorWithRed:73.0/255 green:104/255.0 blue:56/255.0 alpha:1.0] forState:UIControlStateHighlighted];
            [button setTitleColor:[UIColor colorWithRed:73.0/255 green:104/255.0 blue:56/255.0 alpha:1.0] forState:UIControlStateNormal];
			break;
	}
